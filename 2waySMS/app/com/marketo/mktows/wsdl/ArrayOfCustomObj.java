...
public class ArrayOfCustomObj {
    ...
    protected List<CustomObj> customObj;

    /**
     * Gets the value of the customObj property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the customObj property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCustomObj().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CustomObj> getCustomObj() {
        if (customObj == null) {
            customObj = new ArrayList<CustomObj>();
        }
