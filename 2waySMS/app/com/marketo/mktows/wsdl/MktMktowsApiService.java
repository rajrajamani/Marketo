 ...
 * 
 */
@WebServiceClient(name = "MktMktowsApiService", targetNamespace = "http://www.marketo.com/mktows/", wsdlLocation = "http://app-zz.marketo.net/soap/mktows/2_1?WSDL")
public class MktMktowsApiService
    extends Service
{

    private final static URL MKTMKTOWSAPISERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(com.marketo.mktows.wsdl.MktMktowsApiService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.marketo.mktows.wsdl.MktMktowsApiService.class.getResource(".");
            url = new URL(baseUrl, "http://app-zz.marketo.net/soap/mktows/2_1?WSDL");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://app-zz.marketo.net/soap/mktows/2_1?WSDL', retrying as a local file");
