...
public class MktowsClient {
	 ...
	 * @param port
	 */
	public MktowsClient(String mktowsUserId, String encryptionKey, String host, int port) {
	  ...
	  if (port != 80) {
		...
		this.endPoint = protocol + "://" + host + "/soap/mktows/" + MktowsClient.API_VERSION;
	 ...
	 * @return
	 */
	public SuccessDescribeMObject describeMObject(ParamsDescribeMObject paramsDescribeMObject) {
	 ...
	 * @throws DOMException 
	 */
	public List<CampaignRecord> getCampaignsForSource() throws MktowsClientException, MktServiceException {
      ...
      throw new MktServiceException(ex.getMessage() + ", caused by " + fault.getDetail().getTextContent(), ex);
    }
    catch (WebServiceException ex) {
      throw new MktowsClientException("Web service exception occurred: " + ex.getMessage(), ex);
    }
	 ...
	 * @throws MktServiceException 
	 */
	public List<LeadRecord> getLead(LeadKeyRef keyType, String keyValue) throws MktowsClientException, MktServiceException {
	 ...
	 * @throws MktServiceException
	 */
	public List<ActivityRecord> getLeadActivity(int batchSize, List<ActivityType> filter, StreamPostionHolder posHolder) throws MktowsClientException, MktServiceException {
	 ...
	 * @throws MktServiceException
	 */
	public List<ActivityRecord> getLeadActivity(LeadKeyRef keyType, String keyValue, int batchSize, Date latestCreatedAt, Date oldestCreatedAt, List<ActivityType> filter, StreamPostionHolder posHolder) throws MktowsClientException, MktServiceException {
	 ...
	 * @throws  
	 */
	public List<LeadChangeRecord> getLeadChanges(int batchSize, Date latestCreatedAt, Date oldestCreatedAt, List<ActivityType> filter, StreamPostionHolder posHolder) throws MktowsClientException, MktServiceException {
	...
	public List<MObject> getMObjects(String type, Integer id, Attrib externalKey, List<MObjCriteria> listMObjCriteria, List<MObjAssociation> listMObjAssociation, StreamPostionHolder posHolder) throws MktowsClientException, MktServiceException {
	  
	  List<MObject> listMObjects = null;
	  ParamsGetMObjects params = MktowsUtil.objectFactory.createParamsGetMObjects();
	  params.setType(type);
	  if (id != null) {
	    params.setId(id);
	  }
	    ...
	    if (posHolder == null) {
	      throw new MktowsClientException("StreamPostionHolder parameter is required");
	    }
	    Object lastPos = posHolder.getStreamPosition();
	    if (lastPos != null) {
  	    ...
  	    if (listMObjCriteria != null) {
  	      ArrayOfMObjCriteria aoMObjCriteria = MktowsUtil.objectFactory.createArrayOfMObjCriteria();
  	    ...
  	    if (listMObjAssociation != null) {
  	      ArrayOfMObjAssociation aoMObjAssociation = MktowsUtil.objectFactory.createArrayOfMObjAssociation();
  	      aoMObjAssociation.getMObjAssociation().addAll(listMObjAssociation);
	 ...
	 * @throws MktowsClientException
	 */
	public List<LeadRecord> getMultipleLeads(int batchSize, Date oldestUpdatedAt, StreamPostionHolder posHolder) throws MktowsClientException, MktServiceException {
		...
		if (lastPos != null) {
		  ...
		  LastUpdateAtSelector lastUpdateSel = MktowsUtil.objectFactory.createLastUpdateAtSelector();
      lastUpdateSel.setOldestUpdatedAt(MktowsUtil.dateObjectToW3cDate(oldestUpdatedAt));
	 ...
	 * @throws  
	 */
	public List<LeadRecord> getMultipleLeads(int batchSize, Date oldestUpdatedAt, StreamPostionHolder posHolder, List<String> leadAttrs) throws MktowsClientException, MktServiceException {
   ...
   * @throws MktowsClientException
   */
  public List<LeadRecord> getMultipleLeads(int batchSize, String staticListName, StreamPostionHolder posHolder, List<String> leadAttrs) throws MktowsClientException, MktServiceException {
    ...
    if (lastPos != null) {
      ...
      StaticListSelector staticListSel = MktowsUtil.objectFactory.createStaticListSelector();
   ...
   * @throws MktServiceException
   */
  public ImportToListStatusEnum importToList(ImportToListModeEnum importMode, String programName, String listName, String importFileHeader, List<String> importFileRows, String campaignName) throws MktowsClientException, MktServiceException {

    // bulkNewLeadImport
    ImportToListStatusEnum retVal = ImportToListStatusEnum.FAILED;
    
    ParamsImportToList params = MktowsUtil.objectFactory.createParamsImportToList();
   ...
   * @throws MktServiceException
   */
  public ResultGetImportToListStatus getImportToListStatus(String programName, String listName) throws MktowsClientException, MktServiceException {
    
    ResultGetImportToListStatus result = null;
    
    ParamsGetImportToListStatus params = MktowsUtil.objectFactory.createParamsGetImportToListStatus();
    params.setProgramName(programName);
    params.setListName(listName);
    ...
    try {
      AuthenticationHeaderInfo authHdr = this.createAuthenticationHeader();
      MktowsPort soap = this.getSoapInterface();
      SuccessGetImportToListStatus success = soap.getImportToListStatus(params, authHdr);
	 ...
	 * @return
	 */
	public List<String> listMObjects() throws MktowsClientException, MktServiceException {
	 ...
	 * @return
	 */
	public boolean listOperation(ListOperationType listop, String listName, List<LeadKey> leadList, HashMap<String, Boolean> opStatus) throws MktowsClientException, MktServiceException {
	 ...
	 * @return
	 */
	public MergeStatus mergeLeads(List<Attribute> winningLead, List<List<Attribute>> losingLeadList) throws MktowsClientException, MktServiceException {
	 ...
	 * @return
	 */
	public boolean requestCampaign(int campId, List<LeadKey> leadList) throws MktowsClientException, MktServiceException {
   ...
   * @throws MktServiceException
   */
  public boolean requestCampaign(String programName, String campaignName, List<LeadKey> leadKeyList, List<Attrib> tokenList) throws MktowsClientException, MktServiceException {
    ...
    params.setProgramName(programName);
    params.setCampaignName(campaignName);
    ArrayOfLeadKey aoLeadKeys = MktowsUtil.objectFactory.createArrayOfLeadKey();
    aoLeadKeys.getLeadKey().addAll(leadKeyList);
    params.setLeadList(aoLeadKeys);
    if (tokenList != null) {
      ArrayOfAttrib aoTokens = MktowsUtil.objectFactory.createArrayOfAttrib();
   ...
   * @throws MktServiceException
   */
  public boolean scheduleCampaign(String programName, String campaignName, XMLGregorianCalendar runAt, List<Attrib> tokenList) throws MktowsClientException, MktServiceException {
    
    boolean retVal = false;
    ParamsScheduleCampaign params = MktowsUtil.objectFactory.createParamsScheduleCampaign();
    params.setProgramName(programName);
    params.setCampaignName(campaignName);
    ...
    try {
      AuthenticationHeaderInfo authHdr = this.createAuthenticationHeader();
      MktowsPort soap = this.getSoapInterface();
      SuccessScheduleCampaign success = soap.scheduleCampaign(params, authHdr);
	 ...
	 * @throws MktowsClientException 
	 */
	public ResultSyncLead syncLead(LeadRecord leadRec, String marketoCookie, boolean returnLead) throws MktowsClientException, MktServiceException {
	 ...
	 * @throws  
	 */
	public List<SyncStatus> syncMultipleLeads(List<LeadRecord> leadRecList, boolean dedupEnabled) throws MktowsClientException, MktServiceException {
	...
	public List<SyncCustomObjStatus> syncCustomObjects(String objTypeName, List<CustomObj> customObjList, SyncOperationEnum operation) throws MktowsClientException, MktServiceException {
	  
	  List<SyncCustomObjStatus> retVal = null;
	  ArrayOfCustomObj aoCustObj = MktowsUtil.objectFactory.createArrayOfCustomObj();
	  aoCustObj.getCustomObj().addAll(customObjList);
	  ParamsSyncCustomObjects params = MktowsUtil.objectFactory.createParamsSyncCustomObjects();
    ...
    try {
      AuthenticationHeaderInfo authHdr = this.createAuthenticationHeader();
      MktowsPort soap = this.getSoapInterface();
      SuccessSyncCustomObjects success = soap.syncCustomObjects(params, authHdr);
      retVal = success.getResult().getSyncCustomObjStatusList().getSyncCustomObjStatus();
    }
    catch (SOAPFaultException ex) {
      SOAPFault fault = ex.getFault();
      throw new MktServiceException(ex.getMessage() + ", caused by " + fault.getDetail().getTextContent(), ex);
